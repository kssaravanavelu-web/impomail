...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Your important messages, organized in one place. OTPs, jobs, bills, and more." },
      { name: "author", content: "ImpoMail" },
      { property: "og:title", content: "ImpoMail — Only what matters" },
      { property: "og:description", content: "Your important messages, organized in one place." },
